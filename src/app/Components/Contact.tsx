...
const ContactPage: React.FC = () => {
  ...
  return (
    <div id="contact" className="flex flex-col pt-24 bg-white">
      <img
        loading="lazy"
        src="https://cdn.builder.io/api/v1/image/assets/TEMP/225e41c7b7a02a88d384ca23fa9283ab45424242d85c4ffa843828aefccd42f7?placeholderIfAbsent=true&apiKey=b77517f4450544a992d89244a6a7443d"
